...
for test_case in "${test_cases[@]}"; do
    ...
    icpx -fsycl -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lm -DTEST_$test_case -DAMMA_HEADER_PATH=$GEN_HEADER_PATH $INCLUDE_PATHS $ORIGIN_PATH/cluster_bgemm.cpp -o $WORK_DIR/cluster_bgemm
    cd $ORIG_PATH
done

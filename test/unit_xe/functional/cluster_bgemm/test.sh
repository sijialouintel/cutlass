...
EXTRA_DEFS="-DCUTLASS_ENABLE_SYCL -DDEBUG_TID=${DEBUG_TID:-96}"
...
$DPCPP_COMPILER -fsycl -fsycl-targets=spir64_gen -Xs "-device fcs" -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lm -std=c++17 -fPIE $INCLUDE_PATHS $EXTRA_DEFS ../cluster_bgemm.cpp -o cluster_bgemm
...
$DPCPP_COMPILER -fsycl -fsycl-targets=spir64_gen -DVC_WA -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lm -Xs "-device fcs" $INCLUDE_PATHS $EXTRA_DEFS ../cluster_bgemm.cpp -o cluster_bgemm
